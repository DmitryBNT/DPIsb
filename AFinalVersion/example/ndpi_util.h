...
typedef struct ndpi_flow_info {
  ...
  //////////Start Additional Variables
// Time
char time_first_act[80];
char time_last_act[80];
// MAC Address
char mac_address_src[100];
char mac_address_dst[100];
// Company
char company_src[100];
char company_dst[100];
// User_Agent
char user_agent_first[100];
char user_agent_second[100];
